...
const BODIES: Record<MynaIconName, string> = {
  ...
  "chat-dots":
    '<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 12.75v-.5m4 .5v-.5m-8 .5v-.5M12 21a9 9 0 1 0-9-9c0 1.44.338 2.8.94 4.007c.453.911-.177 2.14-.417 3.037a1.17 1.17 0 0 0 1.433 1.433c.897-.24 2.126-.87 3.037-.416A9 9 0 0 0 12 21"/>',
  "chat-dots-solid":
    '<path fill="currentColor" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75s-4.365 9.75-9.75 9.75a9.7 9.7 0 0 1-4.342-1.018c-.21-.104-.523-.114-1.01.005a9 9 0 0 0-.729.22l-.086.03c-.22.074-.46.154-.683.214c-1.427.382-2.733-.924-2.351-2.35c.06-.224.14-.463.214-.684l.03-.086c.085-.255.163-.495.22-.729c.12-.487.11-.8.005-1.01A9.7 9.7 0 0 1 2.25 12m6.5.25a.75.75 0 0 0-1.5 0v.5a.75.75 0 0 0 1.5 0zm4 0a.75.75 0 0 0-1.5 0v.5a.75.75 0 0 0 1.5 0zm4 0a.75.75 0 0 0-1.5 0v.5a.75.75 0 0 0 1.5 0z"/>',
  "external-link":
