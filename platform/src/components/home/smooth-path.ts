/* The curve the sparklines are drawn with. Lives on its own because both the
 * tile/card sparklines and anything else that needs a non-lying curve import
 * it — it used to hang off the study chart, which no longer draws curves. */
