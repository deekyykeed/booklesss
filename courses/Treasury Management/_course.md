...
|--------|---------|--------|
| `_source/06_Introduction to Treasury Management/` | 1 PPTX, 1 PDF | Steps 1.x |
...
| `_source/13_Clearing and Settlement Systems/` | 1 PPTX | Step 4.3 |
| `_source/14_Treasury Management Systems/` | 1 PPTX | Step 4.4 |
...
| 4.3 | `_dev/scripts/build_tm_4_3_clearing-settlement.py` |
| 4.4 | `_dev/scripts/build_tm_4_4_treasury-systems.py` |
