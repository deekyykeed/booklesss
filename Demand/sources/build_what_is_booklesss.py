...
LOGO  = BRAND / "booklesss-wordmark-black.png"

OUT   = HERE.parent  / "What Is Booklesss.pdf"
...
def eb(text):
    ...
    return Paragraph(text, ParagraphStyle(
        ...
        textColor=C_INK, spaceBefore=16, spaceAfter=2, keepWithNext=1
