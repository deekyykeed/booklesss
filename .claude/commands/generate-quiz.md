...
- Either: the path to the `_gamma/` markdown file, OR paste the slide content directly

---

## What this skill does

1. Reads the module's slide content
2. Generates exactly 5 questions (required mix below)
3. Produces two outputs: **student-facing quiz** and **answer key**
4. Saves both to `_gamma/quiz_[N]_[slug].md`
...
```
C:\Users\deeky\OneDrive\Desktop\Booklesss\[Course Folder]\[Course Subfolder]\quizzes\quiz_[NN]_[slug].md
```
