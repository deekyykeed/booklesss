---
name: post-module-to-slack
description: >
  Formats the standard Booklesss module announcement message for posting to the correct
  Slack channel. Use this skill whenever the user wants to post, announce, or share a
  module in Slack after the Gamma deck is published. Trigger when the user says things
  like "post this to Slack", "module is ready to post", "announce Module 2", "write the
  Slack message for this module", or provides a Gamma URL and wants a formatted
  announcement. This skill outputs the exact message to paste into the right channel,
  routes it to the correct #[course-code]-notes channel, and reminds the user to update
  Canvas and generate the quiz.
---
...
2. Identifies the correct `#[course-code]-notes` Slack channel
