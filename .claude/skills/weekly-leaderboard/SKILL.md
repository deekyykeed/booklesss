...
description: >
  Formats and schedules the weekly Booklesss leaderboard post for Slack. Use this skill
  whenever the user wants to post, generate, or schedule a leaderboard update. Trigger
  when the user says things like "post the leaderboard", "it's Sunday", "update the
  rankings", "weekly scores", "who's in the lead", or pastes a table of student points.
  This skill sorts the scores, formats the standard Booklesss leaderboard message with
  medals and top mover callout, and schedules it to #leaderboard for Sunday 7pm CAT.
---
...
4. Schedules to `#leaderboard` for Sunday 7pm CAT (Central Africa Time, UTC+2)
