...
C_INK      = colors.HexColor("#121212")   # amber gold — BBA accent
C_INK_DK   = colors.HexColor("#92400E")   # dark amber — body accent text
...
def make_styles():
    return {
        ...
        "community_link": ParagraphStyle("community_link",
            fontName="Body-Bold", fontSize=9.5, textColor=C_INK_DK,
...
def resources_box(items):
    ...
    s_hd = ParagraphStyle("res_hd", fontName="Body-Bold", fontSize=7,
                           textColor=C_INK, leading=10, alignment=TA_LEFT)
